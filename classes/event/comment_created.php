...
/**
 * The assignsubmission_gradereviews gradereview created event.
 *
...
/**
 * The assignsubmission_gradereviews gradereview created event class.
 *
 * @package    assignsubmission_gradereviews
 * @since      Moodle 2.7
 * @copyright  2013 Rajesh Taneja <rajesh@moodle.com>
...
class comment_created extends \core\event\comment_created {
    ...
    public function get_description() {
        return "The user with id '$this->userid' added the gradereview with id '$this->objectid' to the submission " .
